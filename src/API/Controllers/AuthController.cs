...
public sealed class AuthController : ControllerBase
{
    ...
    {
        var result = await _authService.RequestSignInCodeAsync(
    ...
    {
        var result = await _authService.VerifySignInCodeAsync(
    ...
    public async Task<IActionResult> Refresh(CancellationToken cancellationToken)
    {
        ...
        var tokens = await _authService.RefreshSessionAsync(new RefreshSessionCommand(refreshToken, GetIpAddress()), cancellationToken);
        if (tokens is null)
        {
            DeleteRefreshCookie();
            return Unauthorized();
    ...
    public async Task<IActionResult> GetSessions(CancellationToken cancellationToken)
    {
        ...
        return Ok(await _authService.GetActiveSessionsAsync(userId.Value, cancellationToken));
    }
