...
public interface IOrganizationMembershipService
{
    ...
    /// it creates the organization and its private "tuit.uz" group if this is the first person from that domain —
    /// who becomes the admin — or otherwise joins the user to the organization and its group.
    /// </summary>
