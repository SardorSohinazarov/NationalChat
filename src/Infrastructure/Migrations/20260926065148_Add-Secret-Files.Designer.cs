...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260926065148_Add-Secret-Files")]
    partial class AddSecretFiles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.EmailVerificationCode", b =>
                {
                    ...
                    b.ToTable("email_verification_codes", "security");
                });
            ...
            modelBuilder.Entity("Domain.Entities.SecretChat", b =>
                {
                    ...
                    b.Property<long>("InitiatorLastSeq")
                    ...
                    b.Property<int>("InitiatorSessionId")
                        .HasColumnType("integer");

                    b.Property<int>("ParticipantId")
                        .HasColumnType("integer");

                    b.Property<long>("ParticipantLastSeq")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("Status")
                        .HasColumnType("integer")
                        .HasComment("1 = Pending, 2 = Active, 3 = Closed");

                    b.HasKey("Id");

                    b.HasIndex("InitiatorId");

                    b.HasIndex("InitiatorSessionId", "Status");

                    b.HasIndex("ParticipantId", "Status");

                    b.HasIndex("ParticipantSessionId", "Status");
            ...
            modelBuilder.Entity("Domain.Entities.SecretMessage", b =>
                {
                    ...
                    b.Property<int>("SenderSessionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SecretChatId", "SenderSessionId", "Seq")
                        .IsUnique();

                    b.ToTable("secret_messages", "messaging");
                });
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int>("ScriptPreference")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1)
                        .HasComment("1 = Original, 2 = Latin, 3 = Cyrillic");
            ...
            modelBuilder.Entity("Domain.Entities.SecretChat", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Session", "InitiatorSession")
                        .WithMany()
                        .HasForeignKey("InitiatorSessionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Domain.Entities.Session", "ParticipantSession")
                        .WithMany()
                        .HasForeignKey("ParticipantSessionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Initiator");

                    b.Navigation("InitiatorSession");
